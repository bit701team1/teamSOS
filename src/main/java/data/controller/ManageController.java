...
public class ManageController {
    ...
    public Map<String, Object> blocklist(@RequestParam(defaultValue = "1") int currentPage, @RequestParam(required = true) String search)
    {
        ...
        //검색된 유저의 수
        int totalBlockUserCount=userService.getBlockListCount();
        //총갯수
        totalCount=userService.getManageTotalCountWithBlockUserSearch(search);
        ...
        map.put("totalBlockUserCount",totalBlockUserCount);
