...
public class ManageContoller {
    ...
    public Map<String, Object> blocklist(@RequestParam(defaultValue = "1") int currentPage, @RequestParam(required = true) String search)
    {
        ...
        //search
        System.out.println("getblocklist"+search);
        ...
        //총갯수
        totalCount=userService.getManageBlockCount();
        //총 페이지수
        totalPage=totalCount/perPage+(totalCount%perPage==0?0:1);
        //시작페이지
        startPage=(currentPage-1)/perBlock*perBlock+1;
        ...
        List<UserDto> blist=userService.getManageBlockList(search,startNum,perPage);
